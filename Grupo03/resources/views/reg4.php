...
$cid_1=$cid[1] ;
 ...
 for($i=0;$i<10;$i++){ 
?>
   <?=$cid_1[$i]->Estabelecimento_ID ?> <?=$cid_1[$i]->Nome_Estabelecimento ?> <?=$cid_1[$i]->Est_UF ?> <br>

end="<?=$cid_1[$i]->Nome_Estabelecimento ?> <?=$cid_1[$i]->Endereco ?> <?=$cid_1[$i]->Est_Cidade ?> <?=$cid_1[$i]->Est_UF ?>";
